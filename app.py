...
HISTORY_DIR = Path("chatt_historik") # Skapas på Streamlit-servern
...
def anropa_ai_server(fråga, chatt_historik):
    ...
    try:
        ...
        data = response.json()
        # Vi kan i framtiden visa källorna (data['sources']) om vi vill
        return data.get('answer', 'Fick ett felaktigt svar från servern.')
    except Exception as e:
        return f"FEL: Kunde inte ansluta till AI-servern: {e}"
